    ...
    <div>
      ...
      <footer className="flex flex-col items-center py-10">
        <div id="contacto" className="w-[95%]">
          ...
          <form className="mt-10">
            <div className="grid grid-cols-12">
              ...
              <div className="col-span-3 ml-5 flex flex-col">
            ...
            <div className="grid grid-cols-12 mt-5">
              <div className="col-start-4 col-span-6 flex flex-col">
            ...
            <div className="grid grid-cols-11">
              <button className="col-start-6 mt-5 bg-blue-400 py-2 text-white rounded-sm font-rising-sun font-bold hover:bg-blue-500 transition-all duration-200 ease-in-out" type="submit">Enviar</button>
            </div>
          </form>
        </div>
        ...
        <div className="flex flex-row justify-center">
          <a target="_blank" rel="noreferrer" href="https://twitter.com/aaronsnnchz_" className="w-[100px] h-[100px] text-white rounded-full bg-twitter hover:bg-blue-500 inline-flex items-center justify-center transition-all duration-200 ease-in-out">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-twitter w-[40px] h-[40px]"
              viewBox="0 0 16 16">
              <path
                d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.006-.422A6.685 6.685 0 0 0 16 3.542a6.658 6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0 0 5.026 15z" />
            </svg>
          </a>
          <a target="_blank" rel="noreferrer" href="https://instagram.com/aaronsnnchz_" className="w-[100px] h-[100px] text-white rounded-full bg-instagram hover:bg-purple-800 inline-flex items-center justify-center transition-all duration-200 ease-in-out mx-10">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-instagram w-[40px] h-[40px]"
              viewBox="0 0 16 16">
              <path
          ...
          <a target="_blank" rel="noreferrer" href="https://www.facebook.com/aaron.sanchezmenendez.9/" className="w-[100px] h-[100px] text-white rounded-full bg-facebook hover:bg-blue-900 inline-flex items-center justify-center transition-all duration-200 ease-in-out">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-facebook w-[40px] h-[40px]"
              viewBox="0 0 16 16">
              <path
