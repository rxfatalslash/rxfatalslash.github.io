    ...
    <div>
      ...
      <footer className="flex flex-col items-center py-10">
        ...
        <div className="flex flex-row justify-center">
          <a href="https://twitter.com/aaronsnnchz_" className="w-[100px] h-[100px] text-white rounded-full bg-twitter hover:bg-blue-500 inline-flex items-center justify-center transition-all duration-200 ease-in-out">
          ...
          <a href="https://instagram.com/aaronsnnchz_" className="w-[100px] h-[100px] text-white rounded-full bg-instagram hover:bg-purple-800 inline-flex items-center justify-center transition-all duration-200 ease-in-out mx-10">
          ...
          <a href="https://www.facebook.com/aaron.sanchezmenendez.9/" className="w-[100px] h-[100px] text-white rounded-full bg-facebook hover:bg-blue-900 inline-flex items-center justify-center transition-all duration-200 ease-in-out">
