    ...
    <div>
      ...
      <footer className="flex flex-col items-center py-10">
        ...
        <div className="flex flex-row justify-center">
          <a target="_blank" rel="noreferrer" href="https://twitter.com/aaronsnnchz_" className="w-[50px] lg:w-[100px] h-[50px] lg:h-[100px] text-white rounded-full bg-twitter hover:bg-blue-500 inline-flex items-center justify-center transition-all duration-200 ease-in-out">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-twitter w-[20px] lg:w-[40px] h-[20px] lg:h-[40px]"
              viewBox="0 0 16 16">
              <path
